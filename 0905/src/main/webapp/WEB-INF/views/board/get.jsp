...
<body>
	...
	<script type="text/javascript">
     		 ...
     		 */
     		 ...
     		 /* replyService.update({rno : 11, bno : bnoValue, replytext : "change replytext test"}, function(result){
     			 alert("수정완료");
     		 }); */
           		...
           		function showList(page){
           			replyService.getList({bno:bnoValue, page: page|| 1}, function(list){
           				...
           				for(var i=0, len=list.length||0; i<len; i++){
           					...
           					//str+=" <small class='pull-right text-muted'>"+replyService(list[i].regdate)+"</small></div>";
