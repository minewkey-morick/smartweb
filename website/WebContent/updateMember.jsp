...
<sql:setDataSource var="dataSource"
	url="jdbc:mysql://localhost:3306/youngcha"
	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<c:choose>
						<c:when test="${row.grade eq 1 }">
							일반회원<input name="grade" type="radio" class="form-control" value="1" checked>
						</c:when>
						<c:otherwise>
							일반회원<input name="grade" type="radio" class="form-control" value="1">
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${row.grade eq 2 }">
							관리자<input name="grade" type="radio" class="form-control" value="2" checked>
						</c:when>
						<c:otherwise>
							관리자<input name="grade" type="radio" class="form-control" value="2">
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${row.grade eq 3 }">
							슈퍼관리자<input name="grade" type="radio" class="form-control" value="3" checked>
						</c:when>
						<c:otherwise>
							슈퍼관리자<input name="grade" type="radio" class="form-control" value="3">
						</c:otherwise>
					</c:choose>
				</div>
			</div>
